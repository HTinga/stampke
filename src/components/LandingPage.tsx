...
const PRICING = [
  {
    name: 'Starter', price: 'KES 1,000', period: '/month',
    desc: 'Essential tools for digital presence.',
    highlight: false,
    features: ['Unlimited Digital Stamps','Legally Binding eSign','SVG, PNG & PDF export','Standard Templates','AI Digitizer (3 scans)'],
    missing: ['Smart Invoicing','PDF Editor','AI Summarizer','Scrapping Tool'],
  },
  {
    name: 'Professional', price: 'KES 2,500', period: '/month',
    desc: 'Complete business management suite.',
    highlight: true, badge: 'Most Popular',
    features: ['Everything in Starter','Smart Invoice Generator','Advanced PDF Editor','AI Audio & Doc Summarizer','Unlimited AI Digitizer','Priority Support'],
    missing: ['Web Scrapping Tool','Virtual Assistants'],
  },
  {
    name: 'Enterprise', price: 'KES 7,500', period: '/month',
    desc: 'Elite tools for high-scale operations.',
    highlight: false,
    features: ['Everything in Professional','Advanced Web Scrapping','Virtual Assistants Portal','Custom API Access','Dedicated Account Manager','White-label branding'],
    missing: [],
  },
];
