...
const Dashboard: React.FC<DashboardProps> = ({ userName, onNavigate }) => {
  ...
  const kpiCards = [
    ...
    },
    {
      label: 'AI Scans',
      value: stats.aiScans,
      sub: stats.aiScans === 0 ? 'Digitize rubber stamps' : 'stamps digitized',
      icon: Bot,
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { step: '3', title: 'Request an assistant', desc: 'Find someone for court filings, deliveries, or legal errands in minutes', tab: 'esign', cta: 'Browse Services', color: 'border-emerald-500/30' },
            ].map((s, i) => (
