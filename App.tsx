...
import {
  ...
  ArrowRight, ShieldCheck, Receipt, FileType, FileIcon, Layers,
...
const App: React.FC = () => {
  ...
  const renderView = () => {
    ...
    if (activeView === 'documents-presentation') return <ComingSoon title="Create Presentation" desc="AI-powered presentation builder is coming soon." emoji="📊" />;
    if (activeView === 'documents-create') return <ComingSoon title="Create Document" desc="Document creation with templates coming soon." emoji="📝" />;
