      ...
      <motion.div initial={{ opacity: 0, scale: 0.92, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.92 }}
        ...
        <div>
          <button type="button" onClick={() => {
            ...
            if (!clientId) { setLoginError('Google Sign-In is not configured yet.'); return; }
            setLoginError('');
          ...
          }} className="w-full flex items-center justify-center gap-3 py-3 bg-white border border-[#30363d] hover:bg-gray-50 text-[#18181b] rounded-xl text-sm font-semibold transition-colors shadow-sm">
        ...
        {isSignUp && <p className="text-[10px] text-[#8b949e] text-center">A welcome &amp; verification email is sent immediately. Verify within <strong className="text-white">24 hours</strong> or your account is removed.</p>}
