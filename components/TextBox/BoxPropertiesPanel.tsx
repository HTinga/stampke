...
import type { FreeTextAnnotation, BoxStyle } from '../../src/annotations/types';
import { DEFAULT_BOX_STYLE } from '../../src/annotations/types';
...
export function BoxPropertiesPanel({ annotation, onClose }: BoxPropertiesPanelProps) {
  ...
  const handleBoxStyleChange = useCallback(
    (updates: Partial<BoxStyle>) => {
      ...
      recordUpdate({ ...annotation, boxStyle: newBoxStyle } as any, previousState as any);
    },
  ...
  const handleRectChange = useCallback(
    (newRect: [number, number, number, number]) => {
      ...
      recordUpdate({ ...annotation, rect: newRect } as any, previousState as any);
    },
  ...
  const handleRotationChange = useCallback(
    (rotation: number) => {
      ...
      recordUpdate({ ...annotation, rotation } as any, previousState as any);
    },
    [annotation, updateAnnotation, recordUpdate]
  );
