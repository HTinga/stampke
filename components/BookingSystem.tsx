      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 font-bold uppercase text-[10px] tracking-widest">Manage your schedule</p>
          </div>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-1">
                {bookings.filter(b => isSameDay(b.date, day)).slice(0, 2).map(b => (
                  <div key={b.id} className="text-[9px] font-bold bg-blue-50 text-blue-700 px-2 py-1 rounded-md truncate border border-blue-100">
                    {b.time} - {b.title}
                  </div>
                ))}
                {bookings.filter(b => isSameDay(b.date, day)).length > 2 && (
                  <div className="text-[8px] font-black text-slate-400 uppercase tracking-tighter pl-1">
                    + {bookings.filter(b => isSameDay(b.date, day)).length - 2} more
                  </div>
                )}
              </div>
              <button 
            ...
            <div className="mt-12 bg-white p-10 rounded-[48px] border border-slate-100 shadow-xl">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-2xl font-black text-slate-900 tracking-tight">
                  Schedule for {format(selectedDate, 'MMMM do')}
                </h3>
                <button 
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-slate-900 p-10 rounded-[48px] text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-slate-400 text-sm font-medium mb-8">You have 12 meetings this week.</p>
